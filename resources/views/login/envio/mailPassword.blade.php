...
<body>
    ...
    <h5>Se ha solicitado un cambio de contraseña para este correo. Sigue las instrucciones para completar el cambio</h5>
    <ol>
        <li>Copia la contraseña generada aqui abajo:</li>
        <br>
        Contraseña generada-> {{$datas[0]}}
        <br>
