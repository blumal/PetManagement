...
<body>
    <div class="crear">
        <button name="Crear" value="Crear" id="botoncrear" onclick="abrirmodal_crear(); return false;"><b>CREAR</b></button>
    </div>
    <div class="filtro">
        ...
        <table class="table" id="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class= "edit" type="submit" value="Edit" onclick="abrirmodal_editar({{$prod->id_art}},'{{$prod->nombre_art}}','{{$prod->precio_art}}','{{$prod->codigobarras_art}}','{{$prod->id_ma}}','{{$prod->id_tipo_articulo_fk}}');return false;">Editar</button>
                </td>
                <td>
                    {{-- Route::delete('/clientes/{cliente}',[ClienteController::class,'destroy'])->name('clientes.destroy'); --}}
                    <form method="post">
                        <input type="hidden" name="_method" value="DELETE" id="deleteNotee">
                        <button class="delete" type="submit" value="Delete" onclick="eliminar({{$prod->id_art}}); return false;">Eliminar</button>
                     </form>
                </td>
            </tr>
            @empty
