...
function modificar(id_s, nombre_s, nif_s, email_s, nombre_di, numero_di, cp_di, contacto1_tel, contacto2_tel, horario_apertura_s,
    ...
    contenido += '<input class="btn btn-outline-dark" type="text" name="nombre_s" id="nombre_s" value="' + nombre_s + '"><br>'
    contenido += '<p><b>NIF</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="text" name="nif_s" id="nif_s" value="' + nif_s + '"><br>'
    contenido += '<p><b>Email</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="email" name="email_s" id="email_s" value="' + email_s + '"><br>'
    contenido += '<p><b>Calle</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="text" name="nombre_di" id="nombre_di" value="' + nombre_di + '"><br>'
    contenido += '<p><b>Numero calle</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="number" name="numero_di" id="numero_di" value="' + numero_di + '"><br>'
    contenido += '<p><b>Num telf 1</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="number" name="contacto1_tel" id="contacto1_tel" value="' + contacto1_tel + '"><br>'
    contenido += '<p><b>Num telf 2</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="number" name="contacto2_tel" id="contacto2_tel" value="' + contacto2_tel + '"><br>'
    contenido += '<p><b>Horario apertura</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="time" name="horario_apertura_s" id="horario_apertura_s" value="' + horario_apertura_s + '">'
    contenido += '<p><b>Horario cierre</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="time" name="horario_cierre_s" id="horario_cierre_s" value="' + horario_cierre_s + '">'
    contenido += '<p><b>URL Web</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="text" name="url_web" id="url_web" value="' + url_web + '"><br>'
    contenido += '<p><b>Foto sociedad(Si no queres cambiar la foto deja el campo vacio)</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="file" style="width: 100%;" name="foto_sociedad" id="foto_sociedad"><br>'
    contenido += '<p><b>Foto icono sociedad(Si no queres cambiar la foto deja el campo vacio)</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="file" style="width: 100%;" name="foto_icono_sociedad" id="foto_icono_sociedad"><br>'
    contenido += '<p><b>CP</b><p>'
    contenido += '<input class="btn btn-outline-dark" type="number" name="cp_di" id="cp_di" value="' + cp_di + '">'
...
function crearJS() {
    ...
    contenido += '    <input type="file" class="btn btn-outline-dark" style="width: 100%;" name="foto" id="foto">'
    contenido += '    <span>Foto icono</span>'
    contenido += '    <input type="file" class="btn btn-outline-dark" style="width: 100%;" name="foto_icono" id="foto_icono"><br><br>'
